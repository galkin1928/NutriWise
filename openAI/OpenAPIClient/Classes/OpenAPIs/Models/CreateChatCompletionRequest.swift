...
public struct CreateChatCompletionRequest: Codable, JSONEncodable, Hashable {
    ...
    static let seedRule = NumericRule<Int>(minimum: 9223372036854775616, exclusiveMinimum: false, maximum: -9223372036854775616, exclusiveMaximum: false, multipleOf: nil)
    ...
    public var prediction: CreateChatCompletionRequestPrediction?
    ...
    public init(messages: [ChatCompletionRequestMessage], model: CreateChatCompletionRequestModel, store: Bool? = false, metadata: [String: String]? = nil, frequencyPenalty: Double? = 0, logitBias: [String: Int]? = nil, logprobs: Bool? = false, topLogprobs: Int? = nil, maxTokens: Int? = nil, maxCompletionTokens: Int? = nil, n: Int? = 1, modalities: [Modalities]? = nil, prediction: CreateChatCompletionRequestPrediction? = nil, audio: CreateChatCompletionRequestAudio? = nil, presencePenalty: Double? = 0, responseFormat: CreateChatCompletionRequestResponseFormat? = nil, seed: Int? = nil, serviceTier: ServiceTier? = .auto, stop: CreateChatCompletionRequestStop? = nil, stream: Bool? = false, streamOptions: ChatCompletionStreamOptions? = nil, temperature: Double? = 1, topP: Double? = 1, tools: [ChatCompletionTool]? = nil, toolChoice: ChatCompletionToolChoiceOption? = nil, parallelToolCalls: Bool? = true, user: String? = nil, functionCall: CreateChatCompletionRequestFunctionCall? = nil, functions: [ChatCompletionFunctions]? = nil) {
